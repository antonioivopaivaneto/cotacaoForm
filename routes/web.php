...
Route::post('/enviar',[ SolicitacaoController::class,'enviar']);
Route::get('contato/{titulo}',[ SolicitacaoController::class,'contato']);
Route::get('/sucesso',[ SolicitacaoController::class,'sucesso']);
